...
def run_coarsening_method_experiment(global_config):
    method_values = ["average", "max", "learnable"]
    strided_pool_values = [True, False]
...
if __name__ == "__main__":
    global_config = {
            "seed": 0,                  # Random seed
            "n_runs": 2,#10,               # Number of runs to average results over
    ...
    experiments = ["coarsening_method", "activation_functions", "global_pooling_method"]
